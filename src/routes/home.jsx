...
export default function Home() {
  ...
  return (
    <Wrapper>
      ...
      <BtnWrapper>
        <Button4th className={activeIndex[0] === 0 ? 'active' : null} onClick={() => handleFanPower(0)}>
          <span></span>
          <div className="icon">
            <div></div>
          </div>
        </Button4th>
        <Button className={activeIndex[0] === 1 ? 'active' : null} onClick={() => handleFanPower(1)}>
          <span></span>
          <div className="icon">
            <div></div>
          </div>
        </Button>
        <Button2nd className={activeIndex[0] === 2 ? 'active' : null} onClick={() => handleFanPower(2)}>
          <span></span>
          <div className="icon">
            <div></div>
            <div></div>
        ...
        <Button3rd className={activeIndex[0] === 5 ? 'active' : null} onClick={() => handleFanPower(5)}>
          <span></span>
          <div className="icon">
            <div></div>
            <div></div>
