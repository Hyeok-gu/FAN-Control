  ...
  return (
    <Wrapper>
      ...
      <FanWrapper power={fanInfo === null ? 0 : fanInfo}>
        <img className="fanTop" src="/src/img/fan_top.png"></img>
        <img className="fanMid" src="/src/img/fan_mid.png"></img>
        <img className="fanBottom" src="/src/img/fan_bottom.png"></img>
      </FanWrapper>
      <BtnWrapper>
        <Button4th
